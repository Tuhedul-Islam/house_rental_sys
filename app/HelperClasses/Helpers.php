...
class Helpers
{
     ...
     * @returns string
     */
    public static function orgDateFormat($date): string
    {
     ...
     * @returns string
     */
    public static function titleConverter($title): string
    {
     ...
     * @returns string
     */
    public static function getDomainExtensions(): array
    {
     ...
     */
    public static function starSign()
    {
     ...
     * @returns string
     */
    public static function encrypt_decrypt($key, $type)
    {
    ...
    public static function uploadedFileSize($size, $precision = 2)
    {
        if ($size > 0) {
            $size = (int)$size;
    ...
    public static function uploadedFileSizeInMb($size, $precision = 2)
    {
        if ($size > 0) {
    ...
    //Get Hour from time
    public static function getTotalHour($start_time, $end_time)
    {
        $time1 = $start_time;
        $time2 = $end_time;
    ...
    //Get Hour from time
    public static function activityLog($ticket_id = null, $type = null, $mentioned = null)
    {
