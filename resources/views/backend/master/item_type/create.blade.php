        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header" style="background-color: #DDDDDD">
                    <div class="row">
                        <div class="col-md-6">
                            <h3 class="m-0">Item Type Create</h3>
                        </div>
                        <div class="col-md-6 text-right">
                            <a href="{{ route('item_type') }}" class="btn btn-sm btn-success">Back to List</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{ route('item_type_store') }}" method="post">
                        @CSRF
                        <div class="row">
                            <div class="col-md-12 px-4">
                                <div class="form-group row">
                                    <label for="name" class="col-form-label text-secondary">Name <span class='required_star'> *</span></label>
                                    <input type="name" class="form-control" name="name" id="name" placeholder="Item type Name" autofocus autocomplete="off" required>
                                </div>
                            </div>
                            <div class="col-md-12 px-4">
