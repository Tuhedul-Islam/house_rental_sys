    ...
    <div class="row" style="margin-top: 55px">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ url('/concerns/update/'.$data->id) }}" class="" method="POST" enctype='multipart/form-data'>
                        @CSRF
                        <div class="row">
                            <div class="col-md-12 px-4">
                                <div class="form-group row">
                                    <label for="concern_name" class="col-form-label text-secondary">Concern Name <span class='required_star'> *</span></label>
                                    <input type="text" class="form-control" name="concern_name" id="concern_name" value="{{ $data->concern_name }}" autofocus autocomplete="off" required>
                                </div>
                            </div>
                            <div class="col-md-12 px-4">
                                <div class="form-group row">
                                    <label for="concern_name_bn" class="col-form-label text-secondary">Concern Name Bangla <span class='required_star'> *</span></label>
                                    <input type="text" class="form-control" name="concern_name_bn" id="concern_name_bn" value="{{ $data->concern_name_bn }}" autofocus autocomplete="off" required>
                                </div>
                            </div>
                            <div class="col-md-12 px-4">
                                <div class="form-group row">
                                    <label for="concern_short_name" class="col-form-label text-secondary">Short Concern Name <span class='required_star'> *</span></label>
                                    <input type="text" class="form-control" name="concern_short_name" id="concern_short_name" value="{{ $data->concern_short_name }}" autofocus autocomplete="off" required>
                                </div>
                            </div>
                            <div class="col-md-12 px-4">
                                <div class="form-group row">
                                    <label for="address" class="col-form-label text-secondary">Address <span class='required_star'> *</span></label>
                                    <input type="text" class="form-control" name="address" id="address" value="{{ $data->address }}" autofocus autocomplete="off" required>
                                </div>
                            </div>
                            <div class="col-md-12 px-4">
                                <div class="form-group row">
                                    <label for="mobile" class="col-form-label text-secondary">Mobile <span class='required_star'> *</span></label>
                                    <input type="text" class="form-control" name="mobile" id="mobile" value="{{ $data->mobile }}" autofocus autocomplete="off" required>
                                </div>
                            </div>
                            <div class="col-md-12 px-4">
