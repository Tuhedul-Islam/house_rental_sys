        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header" style="background-color: #DDDDDD">
                    <div class="row">
                        <div class="col-md-6">
                            <h3 class="m-0">Unit/Counter/Desk Create</h3>
                        </div>
                ...
                <div class="card-body">
                    <form action="{{ url('/counter-desks/store') }}" class="" method="POST" enctype='multipart/form-data'>
                        @CSRF
                        <div class="row">
                            <div class="col-md-12 px-4">
                                <div class="form-group row">
                                    ...
                                    <input type="text" class="form-control" name="counter_name" id="counter_name" placeholder="Counter Name" autofocus autocomplete="off" required>
                                </div>
                            </div>
                            <div class="col-md-12 px-4">
                                <div class="form-group row">
                                    <label for="counter_name_bn" class="col-form-label text-secondary">Concern Name Bangla <span class='required_star'> *</span></label>
                                    <input type="text" class="form-control" name="counter_name_bn" id="counter_name_bn" placeholder="Counter Name in Bangla" autocomplete="off" required>
                                </div>
                            </div>
                            <div class="col-md-12 px-4">
                                <div class="form-group row">
                                    <label for="counter_short_name" class="col-form-label text-secondary">Short Concern Name <span class='required_star'> *</span></label>
                                    <input type="text" class="form-control" name="counter_short_name" id="counter_short_name" placeholder="Short Counter Name" autocomplete="off" required>
                                </div>
                            </div>
                            <div class="col-md-12 px-4">
                                <div class="form-group row">
