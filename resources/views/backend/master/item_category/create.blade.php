        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header" style="background-color: #DDDDDD">
                    <div class="row">
                        <div class="col-md-6">
                            <h3 class="m-0">Item Category Create</h3>
                        </div>
                        <div class="col-md-6 text-right">
                            <a href="{{ route('item_category') }}" class="btn btn-sm btn-success">Back to List</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12 px-4">
                                <div class="form-group row">
                                    ...
                                    <input type="name" class="form-control" name="name" id="name" placeholder="Item category Name" autofocus autocomplete="off" required>
                                </div>
                            </div>
                            <div class="col-md-12 px-4">
