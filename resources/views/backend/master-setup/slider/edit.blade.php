                        ...
                        <div class="row">
                            <div class="col-md-6 px-4">
                                <div class="form-group row">
                                    ...
                                    <input type="text" class="form-control" name="text_content" id="text_content" value="{{ $slider->text_content }}" autofocus autocomplete="off" required>
