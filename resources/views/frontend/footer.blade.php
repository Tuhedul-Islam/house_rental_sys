                ...
                <div class="footer_col">
                    ...
                    <div class="footer_content footer_blog">
                        ...
                        <div class="footer_blog_item clearfix">
                            <div class="footer_blog_image"><img src="{{ asset('frequently-changing/frontend/images/footer_blog_1.jpg') }}" alt="https://unsplash.com/@avidenov"></div>
                        ...
                        <div class="footer_blog_item clearfix">
                            <div class="footer_blog_image"><img src="{{ asset('frequently-changing/frontend/images/footer_blog_2.jpg') }}" alt="https://unsplash.com/@deannaritchie"></div>
                            <div class="footer_blog_content">
                        ...
                        <div class="footer_blog_item clearfix">
                            <div class="footer_blog_image"><img src="{{ asset('frequently-changing/frontend/images/footer_blog_3.jpg') }}" alt="https://unsplash.com/@bergeryap87"></div>
                            <div class="footer_blog_content">
                                <div class="footer_blog_title"><a href="blog.html">Travel with us this year</a></div>
                                <div class="footer_blog_date">Nov 29, 2017</div>
                            </div>
                    ...
                    <div class="footer_content footer_contact">
                        <ul class="contact_info_list">
                            <li class="contact_info_item d-flex flex-row">
                                <div><div class="contact_info_icon"><img src="{{ asset('frequently-changing/frontend/images/placeholder.svg') }}" alt=""></div></div>
                                <div class="contact_info_text">4127 Raoul Wallenber 45b-c Gibraltar</div>
                            </li>
                            <li class="contact_info_item d-flex flex-row">
                                <div><div class="contact_info_icon"><img src="{{ asset('frequently-changing/frontend/images/phone-call.svg') }}" alt=""></div></div>
